...
def receive_packet(connection, max_buffer_size):
    ...
    write_to_file("output/received_by_router_2.txt", decoded_packet, send_to_router=None)
...
def processing_thread(connection, ip, port, forwarding_table_with_range, default_gateway_port, max_buffer_size=5120):
    ...
    while True:
        ...
        if ((outPort == "8003") and (new_ttl > 0)):
            ...
            write_to_file("output/discarded_router_2.txt", new_packet)
